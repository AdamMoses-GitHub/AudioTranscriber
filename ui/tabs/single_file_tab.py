...
class SingleFileTab:
    ...
    def __init__(self, parent_notebook, app_controller):
        ...
        self.keep_model_loaded = tk.BooleanVar(value=True)
    ...
    def _create_ui(self):
        ...
        retention_frame.grid(row=1, column=2, sticky="w", padx=(20, 0), pady=(10, 0))
        ttk.Checkbutton(
            retention_frame,
            text="Keep model loaded between single-file runs",
            variable=self.keep_model_loaded,
            command=self.app.save_config
